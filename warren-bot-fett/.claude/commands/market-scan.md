...
`com.example.theborg.warren-bot-fett-daily-market-scan`, executed here in the
session instead of on a schedule — no duplicated instructions.

Read and follow the instructions in
`/Users/localuser/theborg/warren-bot-fett/.claude/scheduled/warren-bot-fett-daily-market-scan.prompt`.
