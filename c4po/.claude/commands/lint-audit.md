...
`com.example.theborg.c4po-lint-audit-monthly`, executed here in the session instead
of on a schedule — no duplicated instructions.

Read and follow the instructions in
`/Users/localuser/theborg/c4po/.claude/scheduled/c4po-lint-audit-monthly.prompt`.
